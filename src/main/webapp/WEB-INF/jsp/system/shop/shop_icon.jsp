...
<body>
			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<div class="row">
						...
						<form action="shop/editicon.do" name="shopForm" id="shopForm" method="post">
						<input type="hidden" name="SHOP_ID" id="shopId" value="${pd.SHOP_ID}"/>
						<input type="hidden" name="SHOP_ICON" id="SHOP_ICON" value=""/>
						<input type="hidden" name="SHOP_ICONColor" id="SHOP_ICONColor" value="black"/>
						<br/>
	...
	<script type="text/javascript">
		...
		function save(){
			...
			$("#SHOP_ICON").val($("#SHOP_ICON").val()+$("#SHOP_ICONColor").val());
			$("#shopForm").submit();
			$("#zhongxin").hide();
			$("#zhongxin2").show();
		}
