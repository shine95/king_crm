                                        ...
                                        <c:if test="${QX.cha == 1 }">
                                            <c:forEach items="${varList}" var="var" varStatus="vs">
                                                <c:forEach items="${packList}" var="pack">
                                                    <c:if test="${var.PACKAGE_ID == pack.id }">
                                                        <tr>
                                                            <td class='center'>
                                                            ...
                                                            <td class='center'>
                                                                <span style="font-weight: bold">${var.PRODUCT_NAME}</span>
                                                            </td>
                                                            <td class='center'>${var.PRODUCT_URL}</td>
                                                            <td class='center'>${var.PRODUCT_IMG}</td>
                                                            <td class='center'>
                                                                <span style="font-weight: 400;color: blue">${pack.name}</span>
                                                            </td>
                                                            <td class='center'>${var.DATE_RATE}</td>
                                                            <td class='center'>${var.SUCC_RATE}</td>
                                                            <td class='center'>
                                                                <c:if test="${var.STATUS == 0}">
                                                                    <span style="font-weight: bold;color: red">空闲</span>
                                                                </c:if>
                                                                <c:if test="${var.STATUS == 1}">
                                                                    <span style="font-weight: bold;color: green">在架</span>
                                                                </c:if>
                                                            </td>
